...
export const skills: Skill[] = [
  ...
  { id: "nextjs", name: "Next.js", category: "frontend", color: "#00c3ff" },
  { id: "tailwind", name: "Tailwind CSS", category: "frontend", color: "#00c3ff" },
  ...
  { id: "python", name: "Python", category: "backend", color: "#7b61ff" },
  { id: "moodle", name: "Moodle", category: "backend", color: "#7b61ff" },
  { id: "mysql", name: "MySQL", category: "backend", color: "#7b61ff" },
  { id: "nodejs", name: "Node.js", category: "backend", color: "#7b61ff" },
  ...
  { id: "docker", name: "Docker", category: "tools", color: "#e0e6f0" },
  { id: "vite", name: "Vite", category: "tools", color: "#e0e6f0" },
  { id: "npm", name: "Npm", category: "tools", color: "#e0e6f0" },
  { id: "figma", name: "Figma", category: "tools", color: "#e0e6f0" }
]
